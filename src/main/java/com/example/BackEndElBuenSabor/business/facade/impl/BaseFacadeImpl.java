...
import com.example.BackEndElBuenSabor.business.facade.IBaseFacade;
...
public abstract class BaseFacadeImpl<E extends BaseEntidad,D extends BaseDto,ID extends Serializable> implements IBaseFacade<D,ID> {
