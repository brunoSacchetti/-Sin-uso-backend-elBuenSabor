...
public class BackEndElBuenSaborApplication {
	...
	CommandLineRunner init() {
		return args -> {
			...
			Domicilio domicilioViamonte = Domicilio.builder().codigoPostal(5509).calle("Viamonte").numero(500).piso(2).nroDepto(23).localidad(localidad1).build();
			Domicilio domicilioSanMartin = Domicilio.builder().codigoPostal(5511).calle("San Martin").numero(789).localidad(localidad2).build();
